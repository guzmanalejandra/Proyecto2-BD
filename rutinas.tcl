...
#  May 27, 2022 10:41:24 AM CST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 443x450+660+210
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    vTcl:withBusyCursor {
    frame $top.fra46 \
        -borderwidth 2 -relief groove -background #000000 -height 465 \
        -width 625 
    ...
    label $site_3_0.lab47 \
        ...
        -foreground #ffffff -text {Añadir pelicula por nombre} 
    ...
    label $site_3_0.lab50 \
        ...
        -foreground #ffffff -text {Eliminar pelicula por nombre} 
    vTcl:DefineAlias "$site_3_0.lab50" "Label2" vTcl:WidgetProc "Toplevel1" 1
    entry $site_3_0.ent51 \
        -background white -disabledforeground #a3a3a3 -font TkFixedFont \
        -foreground $vTcl(actual_gui_fg) -insertbackground black -width 264 
    vTcl:DefineAlias "$site_3_0.ent51" "Entry2" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_3_0.lab47 \
        -in $site_3_0 -x 0 -relx 0.095 -y 0 -rely 0.022 -width 0 \
        -relwidth 0.714 -height 0 -relheight 0.11 -anchor nw \
        -bordermode ignore 
    place $site_3_0.ent48 \
        -in $site_3_0 -x 0 -relx 0.087 -y 0 -rely 0.172 -width 264 \
        -relwidth 0 -height 30 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but49 \
        -in $site_3_0 -x 0 -relx 0.087 -y 0 -rely 0.28 -width 147 -relwidth 0 \
        -height 34 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab50 \
        -in $site_3_0 -x 0 -relx 0.095 -y 0 -rely 0.387 -width 0 \
        -relwidth 0.61 -height 0 -relheight 0.088 -anchor nw \
        -bordermode ignore 
    place $site_3_0.ent51 \
        -in $site_3_0 -x 0 -relx 0.087 -y 0 -rely 0.516 -width 264 \
        -relwidth 0 -height 30 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but52 \
        -in $site_3_0 -x 0 -relx 0.087 -y 0 -rely 0.667 -width 147 \
        -relwidth 0 -height 34 -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.fra46 \
        -in $top -x 0 -relx -0.017 -y 0 -width 0 -relwidth 1.042 -height 0 \
