...
class configurar:
    ...
    def __init__(self, top=None,idCuenta=None):
        ...
        def cancelar():
            self.top = profiles.profiles(self.top,idCuenta)
        #Función para crear un usuario
        def updateUsuario():
            tipoCuenta = "0" if self.TCombobox1.get()=="Gratis" else ("1" if self.TCombobox1.get()=="Estandar" else "2")
            dbQ.updatePlanCuenta(idCuenta,tipoCuenta)
            messagebox.showinfo(title="Actualizacion", message="Se actualizo la cuenta")
            self.top = profiles.profiles(self.top,idCuenta)
        datos = dbQ.getCuentaWithId(idCuenta)
        ...
        self.Frame0.place(relx=0.0, rely=0.0, relheight=1, relwidth=1)
        self.Frame0.configure(relief='groove')
        self.Frame0.configure(borderwidth="2")
        self.Frame0.configure(relief="groove")
        self.Frame0.configure(background="#000000")

        self.combobox = tk.StringVar()
        self.top.configure(background="#000")
        self.Label1 = tk.Label(self.Frame0)
        self.Label1.place(relx=0.3, rely=0.089, height=61, width=250)
        ...
        self.Label1.configure(text='''Configurar cuenta''')
        ...
        mystr = StringVar()
        mystr.set(datos[0])
        self.Entry1 = tk.Entry(self.Frame1,textvariable=mystr)
        ...
        self.Button1 = tk.Button(self.Frame1,command=updateUsuario)
        ...
        self.Button1.configure(text='''Actualizar plan''')
